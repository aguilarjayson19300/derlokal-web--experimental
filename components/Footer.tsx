...
const Footer = ({ logo, address, contactEmail, copyright, externalLinks }: any) => (
    <footer className='bg-secondary7'>
        <div className='container px-8 py-12 mx-auto text-textIcon'>
            <img width="136" height="24" src="/logo.png" alt="me" className='object-cover' />
            <div className='flex flex-col gap-16 py-10 sm:flex-row'>
                <div className='flex-grow'>
                    <h4 className='mb-6 text-lg font-bold'>Download the app</h4>
                ...
                <div className='flex-grow'>
                    <h4 className='mb-6 text-lg font-bold'>Let's to this together</h4>
                ...
                <div className='flex-grow'>
                    ...
                    <ul>
                        <li className='mb-4 text-base font-medium'>
