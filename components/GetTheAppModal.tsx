...
const GetTheAppModal = ({ children, withCloseIcon, onClose, }: GetTheAppModalProps) => {
    return (
        <div className="fixed top-0 left-0 z-20 flex items-center justify-center w-full h-full py-0 transition-all duration-1000 ease-in-out bg-primary bg-opacity-20 sm:py-4 animate__animated animate__fadeInDown">
            <div className="relative w-full h-full bg-white rounded-lg sm:h-4/6 sm:w-1/2 hover:cursor-pointer">
                {withCloseIcon &&                 
